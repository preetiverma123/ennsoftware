<div class="widgets">
  ...
  <div class="row">
    <div class="col-md-12">
      <div
          ba-panel
          ba-panel-title="Enquiries Status"
			...
			<div class="row" ng-controller="esCtrl">
					...
					<div class="row">
						<div class="col-md-2 pull-right form-group">
							<a href="<?php echo site_url('admin/index#/masters/enquiries_status/add')?>" class="btn btn-success "> <i class="ion-android-add"></i>  Add</a>
						</div>
					</div>
						...
						<tr ng-repeat="task in smartTableData track by $index">
						  ...
						  <td>{{smartTableData[$index].name}}</td>
						 	<td>
								...
								<a class="btn btn-primary"  href="<?php echo site_url('admin/index#/masters/enquiries_status/edit/')?>/{{smartTableData[$index].id}}" ><i class="ion-edit"></i> Edit</a>
