<div class="widgets">
  ...
  <div class="row" ng-controller="receiptstuCtrl" >
    <div class="col-md-12" >
      <div
          ba-panel
          ...
          ba-panel-class="with-scroll">
			  ...
			  <div class="form-group" style="padding-top:50px;">
				<button type="button" class="btn btn-primary" ng-click="printData()">Print</button>
					<a href="<?php echo site_url('admin/index#/students/details/') ?>/{{tasks[0].user_id}}" class="btn btn-danger">Close</a>
			  </div>
