  ...
  <div class="row" >
    <div class="col-md-12">
      <div
		  ...
		  <form role="form" ng-submit="addTask()" ng-upload enctype="multipart/form-data" ng-controller="addcertificatestuCtrl" >
			...
			<div class="form-group">
				<label for="issued">Issued On</label>
				 <input type="text" name="issued" class="form-control datepicker" ng-model="issued"  id="issued"/>
			</div>
			  <div class="form-group">
