  ...
  <div class="row" >
    <div class="col-md-12">
      <div
		  ...
		  <form role="form" ng-submit="updateTask(tasks[0])" ng-upload enctype="multipart/form-data" ng-controller="editreceiptstuCtrl" >
			...
			<div class="form-group">
				<label for="input01">Amount</label>
				 <input type="text" name="amount" class="form-control" ng-model="task.amount" id="amount"/>
			</div>
			<div class="form-group">
