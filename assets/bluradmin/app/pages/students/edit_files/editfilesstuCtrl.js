(function () {
  ...
  angular.module('BlurAdmin.pages.students.edit_files')
  	  .controller('editfilesstuCtrl', editfilesstuCtrl);
	
	function editfilesstuCtrl($scope,$http,$window,toastr,$timeout, $upload,$element,$stateParams) {
		$scope.id	=	$stateParams.id;
	
	$http.get(SITE_URL+'/admin/s_api/file/'+ $stateParams.id).success(function(data){
        $scope.tasks = data;
