(function () {
  ...
  angular.module('BlurAdmin.pages.faculties')
      .controller('facultiesCtrl', facultiesCtrl);

  function facultiesCtrl($scope,$http,$window,toastr,DTOptionsBuilder, DTColumnBuilder) {
	 
     $http.get(SITE_URL+'/admin/f_api/tasks').success(function(data){
     	 $scope.tasks = data;
		$scope.vm = {};
