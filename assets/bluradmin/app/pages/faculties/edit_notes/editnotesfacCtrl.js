(function () {
  ...
  angular.module('BlurAdmin.pages.faculties.edit_notes')
  	  .controller('editnotesfacCtrl', editnotesfacCtrl);
	
	function editnotesfacCtrl($scope,$http,$window,toastr,$timeout, $upload,$element,$stateParams) {
		$scope.id	=	$stateParams.id;
	
	$http.get(SITE_URL+'/admin/f_api/note/'+ $stateParams.id).success(function(data){
        $scope.tasks = data;
